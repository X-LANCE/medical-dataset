...
CREATE TABLE `jybgb`  (
  `YLJGDM` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `YLJGDM_MZJZJLB` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `YLJGDM_ZYJZJLB` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `JZLSH_MZJZJLB` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `JZLSH_ZYJZJLB` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  INDEX `YLJGDM_MZJZJLB`(`YLJGDM_MZJZJLB`) USING BTREE,
  INDEX `YLJGDM_ZYJZJLB`(`YLJGDM_ZYJZJLB`) USING BTREE,
  INDEX `JZLSH_MZJZJLB`(`JZLSH_MZJZJLB`) USING BTREE,
  INDEX `JZLSH_ZYJZJLB`(`JZLSH_ZYJZJLB`) USING BTREE,
  CONSTRAINT `jybgb_ibfk_1` FOREIGN KEY (`YLJGDM_MZJZJLB`) REFERENCES `mzjzjlb` (`YLJGDM`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `jybgb_ibfk_2` FOREIGN KEY (`YLJGDM_ZYJZJLB`) REFERENCES `zyjzjlb` (`YLJGDM`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `jybgb_ibfk_3` FOREIGN KEY (`JZLSH_MZJZJLB`) REFERENCES `mzjzjlb` (`JZLSH`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `jybgb_ibfk_4` FOREIGN KEY (`JZLSH_ZYJZJLB`) REFERENCES `zyjzjlb` (`JZLSH`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
