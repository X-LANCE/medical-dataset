...
COLUMN_MAPPING = {
    ...
    ('jybgb', 'YLJGDM_MZJZJLB'): '医疗机构组织机构代码(门诊)',
    ('jybgb', 'YLJGDM_ZYJZJLB'): '医疗机构组织机构代码(住院)',
    ('jybgb', 'BGDH'): '检验报告单号',
    ('jybgb', 'BGRQ'): '报告日期',
    ('jybgb', 'JYLX'): '检验类型',
    ('jybgb', 'JZLSH'): '就诊流水号',
    ('jybgb', 'JZLSH_MZJZJLB'): '门诊就诊流水号',
    ('jybgb', 'JZLSH_ZYJZJLB'): '住院就诊流水号',
    ('jybgb', 'JZLX'): '就诊类型',
    ('jybgb', 'KSBM'): '科室编码',
    ('jybgb', 'KSMC'): '科室名称',
    ('jybgb', 'SQRGH'): '申请人工号',
...
DATASET_NAMES = ['mdsql'] + SINGLE_DOMAIN_DATASET_NAMES + CROSS_DOMAIN_DATASET_NAMES
