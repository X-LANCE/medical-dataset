...
class AbstractSyntaxTreeYlsql(AbstractSyntaxTree):
    ...
    def parse_select(grammar, select):
        ...
        for agg_unit in select:
            ast.sons.append(AbstractSyntaxTreeYlsql.parse_agg_unit(grammar, agg_unit))
        return ast
    ...
    def parse_agg_unit(grammar, agg_unit):
        ast = AbstractSyntaxTreeYlsql('agg_unit')
        if agg_unit[0] == 0:
        ...
        ast.sons.append(AbstractSyntaxTreeYlsql.parse_val_unit(grammar, agg_unit[1]))
        return ast
