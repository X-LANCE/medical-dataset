...
DISEASE_NAMES = [
    ...
    '由于使用阿片类药引起的精神病性障碍', '病理性赌博', '痴呆', '瘙痒症', '癫痫', '癫痫性精神病', '白内障', '白细胞异常', '皮炎', '皮肤疖',
    '睡眠障碍', '矽肺(硅肺)', '矽肺(硅肺)Ⅲ期', '矽肺(硅肺)Ｉ期', '矽肺叁期', '矽肺壹期', '矽肺贰期', '社交恐怖', '神经衰弱',
...
MEDICINE_NAMES = [
    ...
    '抗病毒口服液', '抗病毒颗粒', '护肝宁片(薄膜衣)', '拉莫三嗪片', '替米沙坦片', '木丹颗粒', '枸地氯雷他定片(薄膜)', '枸橼酸坦度螺酮胶囊',
    '柏子仁颗粒', '格列美脲片', '格列齐特缓释片', '桂林西瓜霜', '桔梗颗粒', '止嗽化痰颗粒', '氟哌啶醇片(糖衣)', '氟哌噻吨美利曲辛片',
    '氢氯噻嗪片', '氨磺必利片', '氯化钾缓释片', '氯氮平片', '氯硝西泮片', '氯雷他定片', '汉防己甲素片(薄膜衣)', '消旋山莨菪碱片',
    '消炎利胆片(糖衣)', '清热散结胶囊', '清脑复神液', '炙远志颗粒', '玻璃酸钠滴眼液', '珍珠明目滴眼液', '琥珀酸美托洛尔缓释片',
    '瑞舒伐他汀钙片', '甘草颗粒', '甜梦口服液', '生地黄颗粒', '甲钴胺胶囊', '百乐眠胶囊', '益心舒胶囊', '盐酸丁螺环酮片',
    '盐酸二甲双胍肠溶胶囊', '盐酸倍他司汀片(糖衣)', '盐酸哌甲酯缓释片', '盐酸多塞平片(糖衣)', '盐酸多奈哌齐片(薄膜)', '盐酸多奈哌齐胶囊',
    '盐酸小檗碱片(糖衣)', '盐酸左氧氟沙星胶囊', '盐酸帕罗西汀片', '盐酸帕罗西汀片(薄膜)', '盐酸度洛西汀肠溶片', '盐酸度洛西汀肠溶胶囊',
    '盐酸托莫西汀胶囊', '盐酸文拉法辛缓释片', '盐酸文拉法辛缓释胶囊', '盐酸文拉法辛胶囊', '盐酸普罗帕酮片', '盐酸氟桂利嗪胶囊',
    '盐酸氟西汀分散片', '盐酸氟西汀片', '盐酸氨基葡萄糖胶囊', '盐酸氯丙嗪片(糖衣)', '盐酸氯米帕明片(糖衣)', '盐酸硫必利片',
    '盐酸米安色林片(薄膜)', '盐酸米那普仑片', '盐酸美金刚口服溶液', '盐酸美金刚片(薄膜衣)', '盐酸胺碘酮片', '盐酸舍曲林片',
...
def generate_dataset():
    place_holders = {
        ...
        '人员姓': PlaceHolder('$', ['right_fuzzy'], func=generate_last_name),
