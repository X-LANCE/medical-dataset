...
place_holders = {
    '几': PlaceHolder('$', ['number'], pattern=r'[1-9]'),
    ...
    '检测指标名称': PlaceHolder('$', ['text'], values=['尿比重', '尿酸碱度', '尿白细胞', '尿亚硝酸盐', '尿蛋白', '尿糖', '尿酮体',
        '尿胆原', '尿隐血', '尿红细胞', '红细胞计数', '血红蛋白', '红细胞压积', '红细胞平均体积', '平均细胞血红蛋白',
        '平均细胞血红蛋白浓度', '网织红细胞计数', '血小板计数', '白细胞计数', '脑脊液常规', '精液常规', '前列腺液常规', '总胆红质素',
        '直接胆红素', '总蛋白', '血清白蛋白', '胆固醇']),
